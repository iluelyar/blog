...
function Lr(e, t, n, r, l) {
  ...
  if (((o = 0), (r = r === "" ? "." : r + ":"), nu(e)))
    ...
    for (e = s.call(e), u = 0; !(i = e.next()).done; )
      (i = i.value), (s = r + Ol(i, u++)), (o += Lr(i, t, n, s, l));
  else if (i === "object")
    throw (
      ((t = String(e)),
      Error(
...
var C = Ss.exports;
const zs = Xc(C),
  ff = Yc({ __proto__: null, default: zs }, [C]);
/**
 * @license React
 ...
 */ (function (e) {
  ...
  function r(P) {
    ...
    if (j !== R) {
      P[0] = j;
      e: for (var Q = 0, J = P.length, ar = J >>> 1; Q < ar; ) {
        var St = 2 * (Q + 1) - 1,
          Tl = P[St],
          kt = St + 1,
          cr = P[kt];
        if (0 > l(Tl, j))
          kt < J && 0 > l(cr, Tl)
            ? ((P[Q] = cr), (P[kt] = j), (Q = kt))
            : ((P[Q] = Tl), (P[St] = j), (Q = St));
        else if (kt < J && 0 > l(cr, j)) (P[Q] = cr), (P[kt] = j), (Q = kt);
        else break e;
      }
    }
    return R;
  ...
  function v(P) {
    if (((w = !1), d(P), !y))
      if (n(s) !== null) (y = !0), Rl(x);
      else {
        var R = n(a);
        R !== null && jl(v, R.startTime - P);
      }
  }
  function x(P, R) {
    (y = !1), w && ((w = !1), f(z), (z = -1)), (g = !0);
    var j = m;
    try {
      for (
        d(R), p = n(s);
        p !== null && (!(p.expirationTime > R) || (P && !Le()));
      ...
      if (p !== null) var ar = !0;
        ...
        var St = n(a);
        St !== null && jl(v, St.startTime - R), (ar = !1);
      }
      return ar;
    } finally {
      (p = null), (m = j), (g = !1);
  ...
  (e.unstable_IdlePriority = 5),
    ...
    (e.unstable_scheduleCallback = function (P, R, j) {
      ...
      return (
        ...
        j > Q
          ? ((P.sortIndex = j),
            ...
            n(s) === null &&
              P === n(a) &&
              (w ? (f(z), (z = -1)) : (w = !0), jl(v, j - Q)))
          : ((P.sortIndex = J), t(s, P), y || g || ((y = !0), Rl(x))),
        P
      );
    }),
...
function jf(e, t, n, r, l, i, o, u, s) {
  (Rn = !1), (Vr = null), zf.apply(Rf, arguments);
}
function Tf(e, t, n, r, l, i, o, u, s) {
  if ((jf.apply(this, arguments), Rn)) {
    if (Rn) {
      var a = Vr;
      (Rn = !1), (Vr = null);
...
function qs(e) {
  return (e = Of(e)), e !== null ? bs(e) : null;
}
function bs(e) {
...
function Kf(e, t, n, r, l) {
  switch (t) {
    ...
    case "gotpointercapture":
      return (
        (i = l.pointerId), An.set(i, wn(An.get(i) || null, e, t, n, r, l)), !0
      );
  }
  return !1;
}
...
function yo(e, t, n, r) {
  if (Qr) {
    ...
    else if ((hu(e, r), t & 4 && -1 < Qf.indexOf(e))) {
      for (; l !== null; ) {
        var i = or(l);
        if (
          (i !== null && ia(i),
...
var Kr = null;
function Pi(e, t, n, r) {
  if (((Kr = null), (e = ho(r)), (e = Ct(e)), e !== null))
...
var dn = {
  ...
  hl = A({}, ir, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== kn &&
            (kn && e.type === "mousemove"
              ? (($l = e.screenX - kn.screenX), (Bl = e.screenY - kn.screenY))
              : (Bl = $l = 0),
            (kn = e)),
          $l);
    },
  ...
  gu = ke(hl),
  Jf = A({}, hl, { dataTransfer: 0 }),
  qf = ke(Jf),
  bf = A({}, ir, { relatedTarget: 0 }),
  Vl = ke(bf),
  ed = A({}, dn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  td = ke(ed),
  nd = A({}, dn, {
...
var ad = A({}, ir, {
  ...
  pd = ke(dd),
  hd = A({}, dn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  md = ke(hd),
  vd = A({}, hl, {
    deltaX: function (e) {
...
var wd = Ke && "TextEvent" in window && !jn,
  da = Ke && (!xo || (jn && 8 < jn && 11 >= jn)),
...
function kd(e, t) {
  if (Vt)
    return e === "compositionend" || (!xo && pa(e, t))
      ? ((e = fa()), (jr = wo = rt = null), (Vt = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
  ...
  if (Ke) {
    ...
    if (!Wl) {
      ...
      Eu.setAttribute("oninput", "return;"),
        (Wl = typeof Eu.oninput == "function");
    }
    Al = Wl;
  } else Al = !1;
  va = Al && (!document.documentMode || 9 < document.documentMode);
}
function Cu() {
  Tn && (Tn.detachEvent("onpropertychange", ga), (Hn = Tn = null));
}
function ga(e) {
  if (e.propertyName === "value" && ml(Hn)) {
    var t = [];
    ma(t, Hn, e, ho(e)), Zs(Ed, t);
  }
}
function _d(e, t, n) {
  e === "focusin"
    ? (Cu(), (Tn = t), (Hn = n), Tn.attachEvent("onpropertychange", ga))
    : e === "focusout" && Cu();
}
function Pd(e) {
...
var ka = vl("animationend"),
  xa = vl("animationiteration"),
...
var Ti = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Ud =
    typeof queueMicrotask == "function"
      ...
      : typeof Tu < "u"
      ? function (e) {
          return Tu.resolve(null).then(e).catch($d);
        }
      : Ti;
function $d(e) {
  setTimeout(function () {
...
function wt() {
  if (!Zl && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), ea(mo, wt), l);
    } finally {
      (I = t), (Zl = !1);
    }
  }
...
function Oa(e) {
  ...
  function y(f, c, d, v) {
    for (
      var x = null, N = null, L = c, z = (c = 0), H = null;
      L !== null && z < d.length;
      z++
    ) {
      L.index > z ? ((H = L), (L = null)) : (H = L.sibling);
      var O = m(f, L, d[z], v);
      if (O === null) {
        L === null && (L = H);
        break;
    ...
    if (z === d.length) return n(f, L), $ && xt(f, z), x;
    if (L === null) {
      for (; z < d.length; z++)
        (L = p(f, d[z], v)),
          L !== null &&
            ((c = i(L, c, z)), N === null ? (x = L) : (N.sibling = L), (N = L));
      return $ && xt(f, z), x;
    }
    for (L = r(f, L); z < d.length; z++)
      (H = g(L, f, z, d[z], v)),
        H !== null &&
          (e && H.alternate !== null && L.delete(H.key === null ? z : H.key),
          (c = i(H, c, z)),
  ...
  function w(f, c, d, v) {
    ...
    for (
      var N = (x = null), L = c, z = (c = 0), H = null, O = d.next();
      L !== null && !O.done;
      z++, O = d.next()
    ) {
      L.index > z ? ((H = L), (L = null)) : (H = L.sibling);
    ...
    if (O.done) return n(f, L), $ && xt(f, z), x;
    if (L === null) {
      for (; !O.done; z++, O = d.next())
        (O = p(f, O.value, v)),
          O !== null &&
            ((c = i(O, c, z)), N === null ? (x = O) : (N.sibling = O), (N = O));
      return $ && xt(f, z), x;
    }
    for (L = r(f, L); !O.done; z++, O = d.next())
      (O = g(L, f, z, O.value, v)),
        O !== null &&
    ...
    if (
      ...
      switch (d.$$typeof) {
        ...
        case $t:
          ...
          return o(f);
        case be:
          return (N = d._init), E(f, c, N(d._payload), v);
      }
...
function Do(e, t, n, r, l, i) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (Mr.current = e === null || e.memoizedState === null ? Xd : Gd),
    (e = n(r, l)),
    Mn)
  ) {
    i = 0;
    do {
      if (((Mn = !1), (Jn = 0), 25 <= i)) throw Error(S(301));
      (i += 1),
        (q = G = null),
        (t.updateQueue = null),
        (Mr.current = Zd),
...
function Ga(e, t, n) {
  return (
    (n = n != null ? n.concat([e]) : null), wl(4, 4, Xa.bind(null, t, e), n)
  );
}
function $o() {}
function Za(e, t) {
...
function qa(e, t, n) {
  return jt & 21
    ? (Ie(n, t) || ((n = ra()), (V.lanes |= n), (Tt |= n), (e.baseState = !0)),
      t)
  ...
  Xd = {
    ...
    useImperativeHandle: function (e, t, n) {
      return (
        ...
        Ir(4194308, 4, Xa.bind(null, t, e), n)
      );
    },
...
function bd(e, t, n, r, l, i, o) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = ti(Error(S(422)))), Cr(e, t, o, r))
      : t.memoizedState !== null
  ...
  if (l.data === "$!") {
    ...
    return (r = u), (i = Error(S(419))), (r = ti(i, r, void 0)), Cr(e, t, o, r);
  }
  if (((u = (o & e.childLanes) !== 0), de || u)) {
    ...
    return Ko(), (r = ti(Error(S(421)))), Cr(e, t, o, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
  ...
  switch ((_o(t), t.tag)) {
    ...
    case 6:
      if (e && t.stateNode != null) hc(e, t, e.memoizedProps, r);
        ...
        if (((n = Pt(Zn.current)), Pt(Be.current), xr(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[Ue] = t),
    ...
    case 4:
      return (
        sn(), Qi(e, t), e === null && Kn(t.stateNode.containerInfo), le(t), null
      );
    case 10:
...
function lp(e, t) {
  ...
  for (Ri = { focusedElem: e, selectionRange: n }, Qr = !1, _ = t; _ !== null; )
...
function mc(e) {
  ...
  t !== null && ((e.alternate = null), mc(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Ue], delete t[Xn], delete t[Oi], delete t[Bd], delete t[Vd])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function yc(e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      ze(t, e), De(e), r & 512 && n !== null && Gt(n, n.return);
      break;
    case 5:
      if (
        (ze(t, e),
          ...
          for (_ = l; _ !== null; )
            (o = _),
              ...
              o.tag === 22 && o.memoizedState !== null
                ...
                ? ((s.return = o), (_ = s))
                : ls(l);
        for (; i !== null; ) (_ = i), wc(i), (i = i.sibling);
        (_ = l), (_r = u), (ie = a);
      }
      ns(e);
    } else
      l.subtreeFlags & 8772 && i !== null ? ((i.return = l), (_ = i)) : ns(e);
  }
}
function ns(e) {
  for (; _ !== null; ) {
...
function Me(e, t, n, r) {
  ...
  lr(e, n, r),
    (!(M & 2) || e !== b) &&
      (e === b && (!(M & 2) && (xl |= n), Z === 4 && nt(e, te)),
      me(e, r),
      n === 1 && M === 0 && !(t.mode & 1) && ((cn = K() + 500), yl && wt()));
}
function me(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && pu(n), t === 1))
      e.tag === 0 ? Ad(is.bind(null, e)) : za(is.bind(null, e)),
        Ud(function () {
          !(M & 6) && wt();
        }),
        (n = null);
...
function Sc(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = sl(e, r);
    ...
    M |= 2;
    var i = xc();
    (b !== e || te !== t) && ((Ve = null), (cn = K() + 500), Nt(e, t));
    do
      try {
        ap();
        break;
  ...
  if (t !== 0) {
    if (
      ...
      throw ((n = er), Nt(e, 0), nt(e, r), me(e, K()), n);
    if (t === 6) nt(e, r);
    else {
      if (
...
function is(e) {
  ...
  if (n === 1) throw ((n = er), Nt(e, 0), nt(e, t), me(e, K()), n);
...
Pc = function (e, t, n) {
  ...
  else (de = !1), $ && t.flags & 1048576 && Ra(t, qr, t.index);
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (vo(t, n | 1), me(t, K()), !(M & 6) && ((cn = K() + 500), wt()));
      }
      break;
    case 13:
      Ot(function () {
...
Xs = Ho;
Gs = Ot;
var Sp = { usingClientEntryPoint: !1, Events: [or, Ht, gl, Ks, Ys, Ho] },
  Cn = {
  ...
  kp = {
    ...
    findFiberByHostInstance: Cn.findFiberByHostInstance || yp,
...
function Ip(e, t) {
  ...
  return (
    ...
    n
      .filter((l) => !ps(l))
      .reduce((l, i) => l + (zp.test(i) ? Rp : i === "" ? Tp : Op), r)
  );
}
function Dp(e, t) {
  ...
  for (let u = 0; u < r.length; ++u) {
    ...
    Object.assign(l, p.params),
      o.push({
        ...
        pathnameBase: Wp(ht([i, p.pathnameBase])),
        route: m,
      }),
...
const bo = C.createContext(null),
  Xp = C.createContext(null),
  Dt = C.createContext(null),
  Ll = C.createContext(null),
  Ft = C.createContext({ outlet: null, matches: [], isDataRoute: !1 }),
  Uc = C.createContext(null);
function Gp(e, t) {
  let { relative: n } = t === void 0 ? {} : t;
  sr() || X(!1);
  let { basename: r, navigator: l } = C.useContext(Dt),
...
function zl() {
  return sr() || X(!1), C.useContext(Ll).location;
}
function $c(e) {
  C.useContext(Dt).static || C.useLayoutEffect(e);
}
function Zp() {
  let { isDataRoute: e } = C.useContext(Ft);
  return e ? ah() : Jp();
}
function Jp() {
  sr() || X(!1);
  let e = C.useContext(bo),
    { basename: t, future: n, navigator: r } = C.useContext(Dt),
    { matches: l } = C.useContext(Ft),
    { pathname: i } = zl(),
...
function bp(e, t, n, r) {
  sr() || X(!1);
  let { navigator: l } = C.useContext(Dt),
    { matches: i } = C.useContext(Ft),
    o = i[i.length - 1],
    u = o ? o.params : {};
  o && o.pathname;
...
const th = C.createElement(eh, null);
class nh extends C.Component {
  constructor(t) {
    super(t),
      (this.state = {
        location: t.location,
...
function lh(e, t, n, r) {
  ...
  return o.reduceRight((h, p, m) => {
    ...
    n &&
      ...
      s &&
        (a < 0 && m === 0
          ? (ch("route-fallback", !1), (y = !0), (E = null))
          : a === m &&
...
function dh(e) {
  ...
  return w == null
    ...
    : C.createElement(
        Dt.Provider,
        { value: a },
        C.createElement(Ll.Provider, { children: n, value: w })
      );
}
function ph(e) {
...
function to(e, t) {
  ...
  return (
    C.Children.forEach(e, (r, l) => {
      ...
      r.type !== qe && X(!1), !r.props.index || !r.props.children || X(!1);
      let o = {
...
const kh =
  ...
  Eh = C.forwardRef(function (t, n) {
    let {
      ...
      m = hh(t, gh),
      { basename: g } = C.useContext(Dt),
      y,
      w = !1;
    if (typeof a == "string" && xh.test(a) && ((y = a), kh))
      try {
    ...
    return C.createElement(
      "a",
      no({}, m, { href: y || E, onClick: w || i ? r : c, ref: n, target: s })
    );
  });
var gs;
(function (e) {
...
function _h() {
  return k.jsxs("div", {
    className: "author",
    children: [
      k.jsx("img", { className: "cover", src: "/img/cover.png", alt: "" }),
      k.jsx("img", { className: "avatar", src: "/img/avatar.jpg", alt: "" }),
      k.jsx("div", { className: "name", children: "西北第一深情" }),
      k.jsx("div", { className: "desc", children: "要么庸俗，要么孤独" }),
    ],
  });
}
function Ph() {
  const e = [
    { to: "/", icon: "menu" },
    { to: "/moment", icon: "moment" },
    { to: "/note", icon: "note" },
    { to: "/design", icon: "design" },
    { to: "/tool", icon: "tool" },
    { to: "/project", icon: "project" },
  ];
  return k.jsx("div", {
    className: "nav",
    children: e.map(({ to: t, icon: n }) =>
      k.jsx(
        Eh,
        {
          to: t,
          children: k.jsx("div", {
            className: "item",
            children: k.jsx("img", { src: `/icon/${n}.svg`, alt: "" }),
          }),
        },
        n
      )
...
const oi = [
  { icon: "/img/cover.png", title: "KChart 图表", link: "/design" },
  { icon: "/img/cover.png", title: "KCard 卡片", link: "/design" },
  { icon: "/img/cover.png", title: "KTool 工具", link: "/tool" },
  { icon: "/img/cover.png", title: "KUI 组件库", link: "/null" },
];
function Nh() {
  ...
  C.useEffect(() => {
    const o = e.trim().toLowerCase().split(/\s+/).filter(Boolean),
      u =
        o.length === 0
          ? oi
          : oi.filter((s) => o.every((a) => s.title.toLowerCase().includes(a)));
    r(u);
  }, [e]);
  const l = (i) => {
    const u = e.trim().toLowerCase().split(/\s+/).filter(Boolean);
    if (!u.length) return i;
    const s = u.map((h) => h.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")).join("|"),
      a = new RegExp(`(${s})`, "gi");
    return i.replace(a, '<span class="highlight">$1</span>');
  };
  return k.jsxs("div", {
    className: "search",
    children: [
      k.jsxs("div", {
        ...
        children: [
          k.jsx("div", {
            ...
            children: k.jsx("img", { src: "/icon/search.svg", alt: "" }),
          }),
          k.jsx("input", {
      ...
      k.jsx("div", {
        ...
        children: n.length
          ? n.map((i) =>
              k.jsxs(
                "a",
                {
                  ...
                  children: [
                    k.jsx("img", { src: i.icon, alt: "" }),
                    k.jsx("div", {
                      dangerouslySetInnerHTML: { __html: l(i.title) },
                    }),
                  ],
                },
                i.title
          ...
          : k.jsxs("div", {
              className: "result-item",
              children: [
                k.jsx("img", { src: "/icon/question.svg", alt: "" }),
                k.jsx("div", { children: "未找到结果" }),
              ],
            }),
      }),
    ],
...
function Wc() {
  return k.jsxs("div", {
    className: "slide",
    children: [k.jsx(_h, {}), k.jsx(Ph, {}), k.jsx(Nh, {})],
  });
}
function Hc({ className: e = "panel" }) {
  return k.jsx("div", { className: e, children: "Panel" });
}
function Qc() {
  ...
  return k.jsxs("div", {
    ...
    children: [
      k.jsx("div", {
        className: "ctr-slide",
        onClick: l,
        children: k.jsx("img", { src: "/icon/slider.svg", alt: "" }),
      }),
      k.jsx("div", {
        className: "ctr-panel",
        onClick: i,
        children: k.jsx("img", { src: "/icon/panel.svg", alt: "" }),
      }),
      k.jsx("style", {
        children: `
        .slide {
...
function Lh() {
  return k.jsx("div", { className: "main" });
}
function zh() {
  return k.jsxs("div", {
    className: "blog",
    children: [k.jsx(Wc, {}), k.jsx(Lh, {}), k.jsx(Hc, {}), k.jsx(Qc, {})],
  });
}
function Rh() {
  return k.jsx("div", { children: "Moment Page" });
}
function jh() {
  return k.jsx("div", { children: "Note Page" });
}
function Th() {
  return k.jsx("div", { children: "Design Page" });
}
function Oh() {
  return k.jsx("div", { children: "Tool Page" });
}
function Mh() {
  return k.jsx("div", { children: "Project Page" });
}
function Ih() {
  return k.jsxs("div", {
    className: "blog",
          ...
          children: k.jsxs("div", {
            ...
            children: [
              ...
              k.jsx("div", {
                ...
                children:
                  "此境幽邃，似有还无。君或行至虚实之界，所寻之地已化太虚，暂不可见矣。",
              }),
              k.jsx("div", {
...
function Dh() {
  return k.jsx(Sh, {
    children: k.jsxs(ph, {
      children: [
        k.jsx(qe, { path: "/", element: k.jsx(zh, {}) }),
        k.jsx(qe, { path: "/moment", element: k.jsx(Rh, {}) }),
        k.jsx(qe, { path: "/note", element: k.jsx(jh, {}) }),
        k.jsx(qe, { path: "/design", element: k.jsx(Th, {}) }),
        k.jsx(qe, { path: "/tool", element: k.jsx(Oh, {}) }),
        k.jsx(qe, { path: "/project", element: k.jsx(Mh, {}) }),
        k.jsx(qe, { path: "*", element: k.jsx(Ih, {}) }),
      ],
    }),
  });
}
ui.createRoot(document.getElementById("root")).render(
  k.jsx(zs.StrictMode, { children: k.jsx(Dh, {}) })
);
